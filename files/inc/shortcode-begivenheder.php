	...
	if (have_rows('begivenhed', 'option')):
		...
		while (have_rows('begivenhed', 'option')): the_row();
			...
			if ($sub_file):
				...
				if ($sub_file_txt) {
					echo '<div class="begivenhed-fil' . $file_type_class . '">' . download_icon() . ' <a href="' . $sub_file['url'] . '" target="_blank">' . $sub_file_txt . '</a></div>';
				} else {
					echo '<div class="begivenhed-fil' . $file_type_class . '">' . download_icon() . ' <a href="' . $sub_file['url'] . '" target="_blank">' . $sub_overskrift . '</a></div>';
				}
