<?php
    ...
    function custom_taxonomy_sh_filer() {

    $labels = array(
        'name'                       => _x( 'Klasse', 'Taxonomy General Name', 'skolehjemmesider-domain' ),
        'singular_name'              => _x( 'Klasse', 'Taxonomy Singular Name', 'skolehjemmesider-domain' ),
        'menu_name'                  => __( 'Klasse', 'skolehjemmesider-domain' ),
...
add_action( 'init', 'custom_taxonomy_sh_filer', 2 );