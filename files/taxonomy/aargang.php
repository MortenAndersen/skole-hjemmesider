<?php
    ...
    function custom_taxonomy_sh_aargang() {

    $labels = array(
        'name'                       => _x( 'Årgang', 'Taxonomy General Name', 'skolehjemmesider-domain' ),
        'singular_name'              => _x( 'Årgang', 'Taxonomy Singular Name', 'skolehjemmesider-domain' ),
        'menu_name'                  => __( 'Årgang', 'skolehjemmesider-domain' ),
    ...
    register_taxonomy( 'aargang', array( 'sh_filer' ), $args );
}

add_action( 'init', 'custom_taxonomy_sh_aargang', 2 );