<?php
    ...
    function custom_taxonomy_sh_fag() {

    $labels = array(
        'name'                       => _x( 'Fag', 'Taxonomy General Name', 'skolehjemmesider-domain' ),
        'singular_name'              => _x( 'Fag', 'Taxonomy Singular Name', 'skolehjemmesider-domain' ),
        'menu_name'                  => __( 'Fag', 'skolehjemmesider-domain' ),
    ...
    register_taxonomy( 'fag', array( 'sh_filer', 'sh_personale' ), $args );
}

add_action( 'init', 'custom_taxonomy_sh_fag', 2 );